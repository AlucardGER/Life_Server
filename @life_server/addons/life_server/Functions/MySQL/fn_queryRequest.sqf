...
_query = switch(_side) do {
	case west: {_returnCount = 9; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, cop_licenses, coplevel, cop_gear FROM players WHERE playerid='%1'",_uid];};
